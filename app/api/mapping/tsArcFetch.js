...
function fetchEsriDataToOutputFile(url, outputFile) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, fetch("".concat(url, "/query?where=1=1&outFields=*&outSR=4326&f=geojson"))];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, fs.writeFile(outputFile, JSON.stringify(data, null, 2))];
                case 3:
                    // // Write data to a JSON file
                    _a.sent();
                    console.log("Data successfully written to ".concat(outputFile));
                    return [3 /*break*/, 5];
                case 4:
                    error_1 = _a.sent();
                    console.error("Error fetching ArcGIS data:", error_1);
                    return [3 /*break*/, 5];
