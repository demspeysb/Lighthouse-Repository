...
// These imports relate to dynamic ARCGIS fetching, which is currently a WIP feature
...
export function getDataLayers(): DataLayer[]  {
    ...
    /// This function is a prototype for fetching the ARCGIS layer dynamically, it is not currently in use.
